...
st.write('-> GAZELLE: https://www.adidas.com.br/gazelle?cm_mmc=AdieSEM_Google-_-adidas-LAM-BR-Originals-Gazelle-SB-LF-SEM-BR-_-adidas+gazelle+Shoes-_-adidas+gazelle-_--_-&-_-ds_kid=10326081-_-&-_-ds_agid=147674823305-_-&-_-dv:eCom&cm_mmc1=BR&cm_mmc2=&adicl_gclid=CjwKCAjwqubPBhBOEiwAzgZX2oWZxilxlJOfv49TuGZnuU6jKHqzRrvJXrF0yVgmEThxkIeTsUIzhBoCKIQQAvD_BwE&gclsrc=aw.ds&gad_source=1&gad_campaignid=20016325834&gbraid=0AAAAADgMMA8RpUUyf_vsHUlINvm-baOHO&gclid=CjwKCAjwqubPBhBOEiwAzgZX2oWZxilxlJOfv49TuGZnuU6jKHqzRrvJXrF0yVgmEThxkIeTsUIzhBoCKIQQAvD_BwE')
st.write('-> FORUM: https://www.adidas.com.br/forum')
st.write('-> SUPERSTAR: ')
st.write('-> NMD: https://www.adidas.com.br/nmd ')
st.write('-> ULTRABOOST: https://www.adidas.com.br/ultraboost')
